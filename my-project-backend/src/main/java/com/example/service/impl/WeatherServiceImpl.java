...
public class WeatherServiceImpl implements WeatherService {
    ...
    String key;
    @Qualifier("customerGlobalHeaderOpenApiCustomizer")
    @Autowired
    private OpenApiCustomizer customerGlobalHeaderOpenApiCustomizer;
    ...
    private WeatherVO fetchFromCache(double longitude, double latitude){
        JSONObject geo = decompressStringToJson(rest.getForObject("https://geoapi.qweather.com/v2/city/lookup?location=" + longitude + ',' + latitude + "&key=" + key, byte[].class));
