...
const registerTime = computed(() => new Date(store.user.registerTime).toLocaleTimeString("zh-cn", {
    year: "numeric",
    month: "long",
    day: "numeric"
}))
    ...
    emailFormRef.value.validate((isValid) => {
        if (isValid){
            if (coldTime.value===0){
                ...
                ElMessage.warning(`请等待${coldTime.value}秒后继续！`)
            }
        }
    })
}
    ...
    <div style="display: flex;max-width: 950px;margin: auto">
        <div class="setting-left">
            <card :icon="User" title="账号信息设置" v-loading="loading.form"
                ...
                <el-form label-position="top" style="margin: 0 10px 10px 10px;" :model="baseForm" :rules="rules" ref="baseFormRef">
                    ...
                    <el-form-item label="个人简介" prop="desc">
                        <el-input type="textarea" :rows="6" v-model="baseForm.desc" maxlength="255"/>
                    </el-form-item>
                    <div>
            ...
            <card style="margin-top: 10px" :icon="Message" title="电子邮件设置"
                ...
                <el-form label-position="top" style="margin: 0 10px 10px 10px;" :model="emailForm" :rules="rules" ref="emailFormRef" @validate="onValidate">
                    <el-form-item label="电子邮件" prop="email">
                        <el-input v-model="emailForm.email"/>
                    </el-form-item>
                    <el-form-item label="电子邮件" prop="code">
                        <el-row style="width: 100%" :gutter="10">
                            <el-col :span="18">
                                <el-input placeholder="请获取验证码" v-model="emailForm.code"/>
                            </el-col>
                            <el-col :span="6">
                                <el-button type="success" style="width: 100%" :disabled="coldTime>0 || !isEmailValid" plain @click="sendEmailCode">
                ...
                <card>
                    <div style="text-align: center;padding: 5px 15px 0 15px;">
                        ...
                        <div style="margin: 5px 0">
                            <el-upload :action="axios.defaults.baseURL+'/api/image/avatar'" :show-file-list="false" :before-upload="beforeAvatarUpload" :on-success="uploadSuccess" :headers="accessHeader()">
