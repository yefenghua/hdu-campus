...
import {
    ...
    Document,
    Files,
    Location, Lock, Message, MessageBox,
    Monitor, Operation,
    Position,
    School, Search,
    Umbrella, User
      ...
      <el-container style="height: 100%;" v-if="!loading">
          <el-header class="main-content-header">
              ...
              <div style="flex: 1;padding:0 20px;text-align: center">
                  <el-input style="width: 100%;max-width: 450px;" placeholder="搜索论坛相关内容..." v-model="searchInput.text">
                      <template #prefix>
          ...
          <el-container>
              <el-aside width="230px">
                  <el-scrollbar style="height: calc(100vh - 55px)">
                      <el-menu style="height: calc(100vh - 55px)" :default-active="$route.path" router :default-openeds="['1','2','3']">
                          <el-sub-menu index="1">
                              <template #title>
